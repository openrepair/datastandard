...
product category values* <#product-category-values>`__. Some partner
...
with another field, e.g. “product\_kind” or “item\_type”, e.g.
“Household appliances electric ~ Coffee maker”, this extra detail helps
in the mapping. Normalising the supplied categorisation makes the
...
+-----------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+
| Product category      | *product\_category*                    | Option from ORDS `*product category codelist* <#product-category-values>`__.                                                             |
+-----------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+
...
| Games console                       |                                                    |
+-------------------------------------+----------------------------------------------------+
| Hair & Beauty item                  | e.g. Hair straighteners, toothbrushes, shavers     |
+-------------------------------------+----------------------------------------------------+
| Hair dryer                          |                                                    |
+-------------------------------------+----------------------------------------------------+
| Handheld entertainment device       | e.g. iPods, Walkmans                               |
+-------------------------------------+----------------------------------------------------+
| Headphones                          |                                                    |
+-------------------------------------+----------------------------------------------------+
| Hi-Fi integrated                    |                                                    |
...
| Laptop                              |                                                    |
+-------------------------------------+----------------------------------------------------+
| Large home electrical               | e.g fitness machines, steam cleaners               |
+-------------------------------------+----------------------------------------------------+
| Misc                                |                                                    |
+-------------------------------------+----------------------------------------------------+
| Mobile                              |                                                    |
...
| Paper shredder                      |                                                    |
+-------------------------------------+----------------------------------------------------+
| PC Accessory                        | e.g. mice, keyboards, webcams                      |
+-------------------------------------+----------------------------------------------------+
| Portable radio                      |                                                    |
+-------------------------------------+----------------------------------------------------+
| Power tool                          | e.g. DIY tools                                     |
+-------------------------------------+----------------------------------------------------+
| Printer/scanner                     |                                                    |
+-------------------------------------+----------------------------------------------------+
| Projector                           |                                                    |
...
| Sewing machine                      |                                                    |
+-------------------------------------+----------------------------------------------------+
| Small home electrical               | e.g. baby monitors, doorbells, multimeters         |
+-------------------------------------+----------------------------------------------------+
| Small kitchen item                  | e.g. breadmakers, rice cookers, popcorn machines   |
+-------------------------------------+----------------------------------------------------+
| Tablet                              |                                                    |
+-------------------------------------+----------------------------------------------------+
| Toaster                             |                                                    |
...
| Toy                                 |                                                    |
+-------------------------------------+----------------------------------------------------+
| TV and gaming-related accessories   | e.g. Set top boxes, DVD players                    |
+-------------------------------------+----------------------------------------------------+
| Vacuum                              |                                                    |
+-------------------------------------+----------------------------------------------------+
| Watch/clock                         |                                                    |
